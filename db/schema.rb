...
ActiveRecord::Schema.define(:version => 20090517052012) do
  ...
  create_table "activities", :force => true do |t|
    ...
    t.integer  "gallery_photo_id", :limit => 11
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "review_id",        :limit => 11
    t.integer  "strip_show_id",    :limit => 11
    t.integer  "dare_id",          :limit => 11
    t.integer  "dare_response_id", :limit => 11
    t.integer  "story_id",         :limit => 11
    t.integer  "page_version_id",  :limit => 11
  ...
  create_table "base_dare_responses", :force => true do |t|
    ...
    t.string   "photo"
    t.string   "type"
    t.integer  "dare_challenge_id", :limit => 11
  end
  ...
  create_table "fantasy_actors", :force => true do |t|
    t.integer  "user_id",         :limit => 11
    t.integer  "fantasy_role_id", :limit => 11
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "gallery_photo_files", :force => true do |t|
    ...
    t.integer  "parent_id",              :limit => 11
    t.string   "thumbnail"
    t.integer  "local_gallery_photo_id", :limit => 11
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "gallery_photos", :force => true do |t|
    ...
    t.integer  "photo_set_id", :limit => 11
    t.string   "type"
    t.string   "flickr_id"
    t.string   "server"
    t.string   "secret"
  ...
  create_table "logged_db_times", :force => true do |t|
    ...
    t.integer "visit_count",        :limit => 11
    t.float   "average"
    t.float   "min"
    t.float   "max"
  ...
  create_table "photo_sets", :force => true do |t|
    ...
    t.integer  "minimum_ticks",   :limit => 11
  ...
  create_table "reviews", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "sexyness_rating",   :limit => 11
    t.integer  "durability_rating", :limit => 11
    t.integer  "cleaning_rating",   :limit => 11
    t.integer  "pleasure_rating",   :limit => 11
    t.integer  "overall_rating",    :limit => 11
    t.text     "body"
  end
  ...
  create_table "sponsorship_payments", :force => true do |t|
    t.integer  "sponsorship_id", :limit => 11
    t.integer  "amount_cents",   :limit => 11
    t.datetime "created_at"
  end
  ...
  create_table "strip_photo_views", :force => true do |t|
    t.integer "strip_photo_id", :limit => 11
    t.integer "user_id",        :limit => 11
  end
  ...
  create_table "strip_show_views", :force => true do |t|
    t.integer  "strip_show_id",       :limit => 11
    t.integer  "user_id",             :limit => 11
    t.integer  "max_position_viewed", :limit => 11
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "syndicated_blog_articles", :force => true do |t|
    ...
    t.text     "author"
    t.text     "link"
    t.integer  "syndicated_blog_id", :limit => 11
    t.datetime "updated_at"
    t.text     "content"
    t.text     "raw_content"
  ...
  create_table "tag_ranks", :force => true do |t|
    ...
    t.integer  "story_count",         :limit => 11, :default => 0
    t.integer  "profile_count",       :limit => 11, :default => 0
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "story_ratio",         :limit => 11, :default => 0
    t.integer  "profile_ratio",       :limit => 11, :default => 0
    t.integer  "dare_count",          :limit => 11, :default => 0
    t.integer  "dare_ratio",          :limit => 11, :default => 0
    t.integer  "blog_article_count",  :limit => 11, :default => 0
    t.integer  "blog_article_ratio",  :limit => 11, :default => 0
    t.integer  "global_ratio",        :limit => 11, :default => 0
    t.integer  "global_count",        :limit => 11, :default => 0
    t.integer  "gallery_photo_count", :limit => 11
    t.integer  "gallery_photo_ratio", :limit => 11
    t.integer  "review_count",        :limit => 11, :default => 0
    t.integer  "review_ratio",        :limit => 11, :default => 0
  end
